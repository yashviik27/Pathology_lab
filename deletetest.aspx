<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminsite.Master" AutoEventWireup="true" CodeBehind="deletetest.aspx.cs" Inherits="PathLab.Admin.WebForm21" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
            ...
            <li class="breadcrumb-item active" aria-current="page">Delete Tests</li>
         </ol>
	   </div>
	   <div class="col-sm-3">
    ...
    <div class="card">
     ...
     <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box">
                            <h4 class="card-title">Delete Test</h4>

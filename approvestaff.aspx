<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminsite.Master" AutoEventWireup="true" CodeBehind="approvestaff.aspx.cs" Inherits="PathLab.Admin.WebForm7" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

     <!-- Breadcrumb-->
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Approve Staff</h4>
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javaScript:void();">Admin</a></li>
            <li class="breadcrumb-item"><a href="javaScript:void();">Staff Records</a></li>
            <li class="breadcrumb-item active" aria-current="page">Approve Staff</li>
         </ol>
	   </div>
	   <div class="col-sm-3">
    ...
    <!-- End Breadcrumb-->
           ...
           <div class="card">
           <div class="card-body">
           <div class="card-title">Approve Staff Records</div>
           <hr>
            <form runat="server">
          ...
          <div class="form-group row">
           ...
           <%--<input type="checkbox" id="user-checkbox6" checked=""/>--%>
            ...
            <label for="user-checkbox6">Approve Staff</label>
            </div>
            </div>
          </div>
           <div class="form-group row">
           ...
           <%-- <button type="submit" class="btn btn-primary btn-round px-5"><i class="icon-lock"></i> Register</button>--%>
                <asp:Button ID="Button1" runat="server" Text="Approve" class="btn btn-primary btn-round px-5" OnClick="Button1_Click" />
            </div>
          </div>
          </form>
         </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bloodreport.aspx.cs" Inherits="PathLab.User.WebForm10" %>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [blood_test] WHERE ([uname] = @uname)">
                                    <SelectParameters>

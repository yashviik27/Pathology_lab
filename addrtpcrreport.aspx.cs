...
namespace PathLab.Doctor
{
    public partial class WebForm5 : System.Web.UI.Page
    {
        ...
        {
            cn.Open();
            qry = "insert into rtpcr_test values('" + DropDownList2.SelectedItem.Value + "','" + DropDownList1.SelectedItem.Value + "','" + txtage.Text + "','" + txtncov2.Text + "','" + txtreport.Text + "','" + txtprice.Text + "','" + txtdate.Text + "')";

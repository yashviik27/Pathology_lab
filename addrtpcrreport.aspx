<%@ Page Title="" Language="C#" MasterPageFile="~/Doctor/doctorsite.Master" AutoEventWireup="true" CodeBehind="addrtpcrreport.aspx.cs" Inherits="PathLab.Doctor.WebForm5" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
         <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box">
                            <h4 class="card-title">Add Rt PCR Report</h4>
                            <form id="form1" runat="server">
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    <label class="col-form-label col-md-2">nCov2</label>
                                    <div class="col-md-10">
                                        <%--<input type="text" class="form-control" disabled="disabled">--%>
                                        <asp:TextBox ID="txtncov2" runat="server" class="form-control"></asp:TextBox>
                                    </div>
                                </div>

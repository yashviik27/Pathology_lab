...
namespace PathLab.Doctor
{
    public partial class WebForm6 : System.Web.UI.Page
    {
        ...
        {
            cn.Open();
            qry = "insert into liver_test values('" + DropDownList2.SelectedItem.Value + "','" + DropDownList1.SelectedItem.Value + "','" + txtalt.Text + "','" + txtast.Text + "','" + txtprotien.Text + "','" + txtreport.Text + "','" + txtprice.Text + "','" + txtdate.Text + "')";

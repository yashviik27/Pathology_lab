<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminsite.Master" AutoEventWireup="true" CodeBehind="edittest.aspx.cs" Inherits="PathLab.Admin.WebForm20" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
            ...
            <li class="breadcrumb-item"><a href="javaScript:void();">View Tests</a></li>
            <li class="breadcrumb-item active" aria-current="page">Edit Tests</li>
         </ol>
	   </div>
	   <div class="col-sm-3">
    ...
    <!-- End Breadcrumb-->
     ...
     <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box">
                            <h4 class="card-title">Edit Tests</h4>
                            <form id="form1" runat="server">
                                ...
                                <div class="form-group row">
                                 <label class="col-form-label col-md-2"></label>
                                    ...
                                    <asp:Button ID="btnedit" runat="server" Text="Update" class="btn btn-primary" OnClick="btnedit_Click"  />
                                </div>
                                            </div>

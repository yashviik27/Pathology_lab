<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rtpcrreport.aspx.cs" Inherits="PathLab.User.WebForm8" %>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [rtpcr_test] WHERE ([uname] = @uname)">
                                    <SelectParameters>

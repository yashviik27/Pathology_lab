<%@ Page Title="" Language="C#" MasterPageFile="~/User/usersite.Master" AutoEventWireup="true" CodeBehind="makeappointment.aspx.cs" Inherits="PathLab.User.WebForm3" %>
          ...
          <div class="row">
              ...
              <form runat="server" >
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group mb-10">
                    <%--  <input id="form_email" name="form_email" class="form-control required email" type="email" placeholder="Enter Email" aria-required="true">--%>
                        <asp:DropDownList ID="DropDownList1" class="form-control" runat="server" DataSourceID="SqlDataSource1" DataTextField="docname" DataValueField="docname"></asp:DropDownList>
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group mb-10">
                    <%--  <input id="form_email" name="form_email" class="form-control required email" type="email" placeholder="Enter Email" aria-required="true">--%>
                        <asp:DropDownList ID="DropDownList2" class="form-control" runat="server" DataSourceID="SqlDataSource2" DataTextField="testname" DataValueField="testname"></asp:DropDownList>
                ...
                <div class="form-group mb-0 mt-20">
                 ...
                 <%-- <button type="submit" class="btn btn-dark btn-theme-colored btn-lg btn-flat" data-loading-text="Please wait...">Submit Now</button>--%>
                    <asp:Button ID="btnsubmit" runat="server" Text="Book" OnClick="btnsubmit_Click" class="btn btn-dark btn-theme-colored btn-lg btn-flat"/>
                </div>
              </form>
            ...
            <div class="col-md-5">
              <img alt="" src="images/photos/1.png" class="img-responsive img-fullwidth">
                ...
                <h2><a href="testdisplay.aspx">Test details</a></h2>
</asp:Content>

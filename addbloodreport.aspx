<%@ Page Title="" Language="C#" MasterPageFile="~/Doctor/doctorsite.Master" AutoEventWireup="true" CodeBehind="addbloodreport.aspx.cs" Inherits="PathLab.Doctor.WebForm2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box">
                            <h4 class="card-title">Add Blood Report</h4>
                            <form id="form1" runat="server">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-md-2">Red Blood Cells count</label>
                                    <div class="col-md-10">
                                        <%--<input type="text" class="form-control" disabled="disabled">--%>
                                        <asp:TextBox ID="txtrbc" runat="server" class="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                 <div class="form-group row">
                                    <label class="col-form-label col-md-2">White Blood Cells count</label>
                                    <div class="col-md-10">
                                        <%--<input type="text" class="form-control" disabled="disabled">--%>
                                        <asp:TextBox ID="txtwbc" runat="server" class="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-md-2">Platelets</label>
                                    <div class="col-md-10">
                                       <%-- <input type="text" class="form-control" value="readonly" readonly="readonly">--%>
                                        <asp:TextBox ID="txtplatelets" runat="server" class="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-md-2">Hemoglobin</label>
                                    <div class="col-md-10">
                                       <%-- <input type="text" class="form-control" placeholder="Placeholder">--%>
                                        <asp:TextBox ID="txthemo" runat="server" class="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group row">

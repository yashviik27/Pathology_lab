...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pregnancyreport.aspx.cs" Inherits="PathLab.User.WebForm6" %>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [pregnancy_test] WHERE ([uname] = @uname)">
                                    <SelectParameters>
                                    ...
                                    <asp:Repeater ID="Repeater2" runat="server" DataSourceID="SqlDataSource2" >
                                        ...
                                        <HeaderTemplate>
                                            ...
                                            <thead>
                                                <tr>
                                                    <th>Doctor Name</th>
                                                    <th>HCG(Human Chorionic Gonadotropin)</th>
                                                    <th>HCG Level</th>
                                                    <th>Report</th>
                                                    <th>Price</th>
                                                    <th>Date</th>

<%@ Page Title="" Language="C#" MasterPageFile="~/Staff/staffsite.Master" AutoEventWireup="true" CodeBehind="deletedoctor.aspx.cs" Inherits="PathLab.Staff.WebForm5" %>
   ...
   <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box">
                            <h4 class="card-title">Delete Doctor</h4>
                                ...
                                <div class="form-group row">
                                 <label class="col-form-label col-md-2"></label>
                                    <div class="col-md-10">
                                        ...
                                        <asp:Button ID="btndelete" runat="server" Text="Delete" class="btn btn-primary" OnClick="btndelete_Click1" />
                                </div>
                                            </div>
